...
//public class PesquisaControllerAntigo {
//
//    private final PesquisaServiceAntiga service;
//    private final PesquisaRepositoryAntigo repository;
//
//    // =========================== CREATE ===========================
//
//    @PostMapping
//    public ResponseEntity<?> create(@Valid @RequestBody PesquisaRequestDTOAntigo body) {
//        // Monta a entidade a partir do DTO (seus DTOs trazem entidades completas)
//        PesquisaAntiga entity = new PesquisaAntiga();
//        entity.setConsumoAntigo(body.consumoAntigo());
...
//        PesquisaResponseDTOAntiga dto = PesquisaResponseDTOAntiga.fromEntity(entity);
...
//
//    @GetMapping("/{id}")
//    public ResponseEntity<PesquisaResponseDTOAntiga> findById(@PathVariable Long id) {
//        PesquisaAntiga p = service.search(id);
//        if (p == null) throw new NoSuchElementException("Pesquisa not found");
//        return ResponseEntity.ok(PesquisaResponseDTOAntiga.fromEntity(p));
//    }
//
//    /**
...
//     */
//    @GetMapping
//    public ResponseEntity<Page<PesquisaResponseDTOAntiga>> list(Pageable pageable,
...
//
//        Page<PesquisaResponseDTOAntiga> page;
//
//        if (consumoId != null) {
//            page = repository.findByConsumo_Id(consumoId, pageable)
//                    .map(PesquisaResponseDTOAntiga::fromEntity);
//
...
//                                    @Valid @RequestBody PesquisaRequestDTOAntigo body) {
//
//        PesquisaAntiga dados = new PesquisaAntiga();
//        dados.setConsumoAntigo(body.consumoAntigo());
...
//        }
//
//        PesquisaAntiga atual = service.search(id);
//        return ResponseEntity.ok(PesquisaResponseDTOAntiga.fromEntity(atual));
//    }
//
//    // ============================ DELETE ==========================
//
