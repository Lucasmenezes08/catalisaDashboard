...
$(function() {
	...
	$.fn.bootstrapFileInputPhoto = function() {
		  ...
		  this.each(function(i,elem){
		    ...
		    var buttonWord = 'Fazer upload de arquivo';
		    ...
		    $elem.replaceWith('<a class="file-input-wrapper"><div class="_input_file-nema' +className+ '"></div><strong class="">'+input+"</strong></a>");
		  })
		  ...
		  .promise().done( function(){
		    ...
		    $('.file-input-wrapper input[type=file]').change(function(){
		      ...
		      $(this).parents('.file-input-wrapper').find('._input_file-nema').html('<span class="file-input-name">'+fileName+'</span>');
		    });
...
$.fn.bootstrapFileInput = function() {
  ...
  this.each(function(i,elem){
    ...
    // Now we're going to replace that input field with a Bootstrap button.
    // The input will actually still be there, it will just be float above and transparent (done with the CSS).
    $elem.replaceWith('<a class="file-input-wrapper"><div class="_input_file-nema' +className+ '"></div><strong class="file-button btn btn-small btn-main">'+buttonWord+input+'</strong></a>');
  })
